...
// CHECK: omp_loop.exit:
// CHECK: call void @__kmpc_for_static_fini(ptr @2, i32 %omp_global_thread_num3)
// CHECK: %omp_global_thread_num4 = call i32 @__kmpc_global_thread_num(ptr @2)
// CHECK: call void @__kmpc_barrier(ptr @3, i32 %omp_global_thread_num4)
...
// CHECK: call void @__kmpc_barrier(ptr @1, i32 %omp_global_thread_num5)
